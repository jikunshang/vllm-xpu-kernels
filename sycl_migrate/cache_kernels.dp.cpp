...
void swap_blocks(torch::Tensor& src, torch::Tensor& dst,
  ...
  for (size_t i = 0; i < num_blocks; i++) {
    ...
    /*
    DPCT1124:254: cudaMemcpyAsync is migrated to asynchronous memcpy API. While
    ...
    cgh.parallel_for(                                                          \
        ...
        [=](sycl::nd_item<3> item_ct1) {                                       \
          vllm::reshape_and_cache_flash_kernel<KV_T, CACHE_T, KV_DTYPE>(       \
              key_data_ptr_ct0, value_data_ptr_ct1, key_cache_data_ptr_ct2,    \
              value_cache_data_ptr_ct3, slot_mapping_data_ptr_int64_t_ct4,     \
              block_stride_ct5, page_stride_ct6, head_stride_ct7,              \
              key_stride_ct8, value_stride_ct9, num_heads_ct10,                \
              head_size_ct11, block_size_ct12, k_scale_data_ptr_ct13,          \
              v_scale_data_ptr_ct14, item_ct1);                                \
        });                                                                    \
  });
    ...
    cgh.parallel_for(                                                          \
        ...
        [=](sycl::nd_item<3> item_ct1) {                                       \
          vllm::concat_and_cache_mla_kernel<KV_T, CACHE_T, KV_DTYPE>(          \
              ...
              kv_lora_rank_ct8, pe_dim_ct9, block_size_ct10,                   \
              scale_data_ptr_ct11, item_ct1);                                  \
        });                                                                    \
  });
    ...
    cgh.parallel_for(sycl::nd_range<3>(grid * block, block),                 \
                     [=](sycl::nd_item<3> item_ct1) {                        \
                       vllm::gather_cache<CPY_DTYPE>(                        \
                           ...
                           block_table_data_ptr_int32_t_ct2,                 \
                           cu_seq_lens_data_ptr_int32_t_ct3, block_size_ct4, \
                           entry_size_ct5, block_table_stride_ct6,           \
                           cache_block_stride_ct7, cache_entry_stride_ct8,   \
                           dst_entry_stride_ct9, seq_starts_ptr_ct10,        \
                           item_ct1);                                        \
                     });                                                     \
  });
