    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(
          sycl::nd_range<3>(sycl::range<3>(1, 1, nb) * sycl::range<3>(1, 1, 32),
                            sycl::range<3>(1, 1, 32)),
          [=](sycl::nd_item<3> item_ct1) {
            dequantize_block_iq2_xxs(vx, y, item_ct1, iq2xxs_grid_ptr_ct1,
    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(
          sycl::nd_range<3>(sycl::range<3>(1, 1, nb) * sycl::range<3>(1, 1, 32),
                            sycl::range<3>(1, 1, 32)),
          [=](sycl::nd_item<3> item_ct1) {
            dequantize_block_iq2_xs(vx, y, item_ct1, iq2xs_grid_ptr_ct1,
                                    ksigns_iq2xs_ptr_ct1, kmask_iq2xs_ptr_ct1);
          });
    });
  }
    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(
          sycl::nd_range<3>(sycl::range<3>(1, 1, nb) * sycl::range<3>(1, 1, 32),
                            sycl::range<3>(1, 1, 32)),
          [=](sycl::nd_item<3> item_ct1) {
            dequantize_block_iq2_s(vx, y, item_ct1, iq2s_grid_ptr_ct1,
                                   kmask_iq2xs_ptr_ct1);
          });
    });
  }
    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(
          sycl::nd_range<3>(sycl::range<3>(1, 1, nb) * sycl::range<3>(1, 1, 32),
                            sycl::range<3>(1, 1, 32)),
          [=](sycl::nd_item<3> item_ct1) {
            dequantize_block_iq3_xxs(vx, y, item_ct1, iq3xxs_grid_ptr_ct1,
                                     ksigns_iq2xs_ptr_ct1, kmask_iq2xs_ptr_ct1);
          });
    });
  }
    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(
          sycl::nd_range<3>(sycl::range<3>(1, 1, nb) * sycl::range<3>(1, 1, 32),
                            sycl::range<3>(1, 1, 32)),
          [=](sycl::nd_item<3> item_ct1) {
            dequantize_block_iq3_s(vx, y, item_ct1, iq3xs_grid_ptr_ct1,
                                   kmask_iq2xs_ptr_ct1);
          });
    });
  }
    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(
          sycl::nd_range<3>(sycl::range<3>(1, 1, nb) * sycl::range<3>(1, 1, 32),
                            sycl::range<3>(1, 1, 32)),
          [=](sycl::nd_item<3> item_ct1) {
            dequantize_block_iq1_s(vx, y, item_ct1, iq1s_grid_gpu_ptr_ct1);
          });
    });
  }
}
    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(
          sycl::nd_range<3>(sycl::range<3>(1, 1, nb) * sycl::range<3>(1, 1, 32),
                            sycl::range<3>(1, 1, 32)),
          [=](sycl::nd_item<3> item_ct1) {
            dequantize_block_iq1_m(vx, y, item_ct1, iq1s_grid_gpu_ptr_ct1);
          });
    });
  }
}
    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(
          sycl::nd_range<3>(sycl::range<3>(1, 1, nb) * sycl::range<3>(1, 1, 32),
                            sycl::range<3>(1, 1, 32)),
          [=](sycl::nd_item<3> item_ct1) {
            dequantize_block_iq4_nl(vx, y, item_ct1, kvalues_iq4nl_ptr_ct1);
          });
    });
  }
}
    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(
          sycl::nd_range<3>(sycl::range<3>(1, 1, nb) * sycl::range<3>(1, 1, 32),
                            sycl::range<3>(1, 1, 32)),
          [=](sycl::nd_item<3> item_ct1) {
            dequantize_block_iq4_xs(vx, y, item_ct1, kvalues_iq4nl_ptr_ct1);
          });
    });
  }
}
