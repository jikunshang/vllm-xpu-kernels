...
#include "vecdotq.dp.hpp"
#include "dequantize.dp.hpp"
#include "mmvq.dp.hpp"
#include "mmq.dp.hpp"
#include "moe.dp.hpp"
#include "moe_vec.dp.hpp"
...
static void quantize_row_q8_1_cuda(const scalar_t* x, void* vy, const int kx,
  ...
  for (int off = 0; off < ky; off += MAX_BLOCK_SIZE) {
    ...
    stream->submit([&](sycl::handler& cgh) {
      ...
      cgh.parallel_for(sycl::nd_range<3>(num_blocks * block_size, block_size),
                       [=](sycl::nd_item<3> item_ct1) {
                         quantize_q8_1(x_off_kx_ct0,
                                       int32_t_vy_off_kx_padded_ct1, kx,
                                       kx_padded, item_ct1);
                       });
    });
  }
