...
__dpct_inline__ float GroupReduceMax(float val, const int tid,
  ...
  /*
  DPCT1023:161: The SYCL sub-group does not support mask options for
  ...
  */
  ...
  /*
  DPCT1023:162: The SYCL sub-group does not support mask options for
  dpct::permute_sub_group_by_xor. You can specify
  "--use-experimental-features=masked-sub-group-operation" to use the
  experimental helper function to migrate __shfl_xor_sync.
  */
  ...
  /*
  DPCT1023:163: The SYCL sub-group does not support mask options for
  dpct::permute_sub_group_by_xor. You can specify
  "--use-experimental-features=masked-sub-group-operation" to use the
  experimental helper function to migrate __shfl_xor_sync.
  */
  ...
  /*
  DPCT1023:164: The SYCL sub-group does not support mask options for
  dpct::permute_sub_group_by_xor. You can specify
  "--use-experimental-features=masked-sub-group-operation" to use the
  experimental helper function to migrate __shfl_xor_sync.
  */
...
void per_token_group_quant_8bit_kernel(
  ...
  /*
  DPCT1065:345: Consider replacing sycl::nd_item::barrier() with
