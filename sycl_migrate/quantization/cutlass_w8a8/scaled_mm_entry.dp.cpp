...
#if defined DPCT_COMPAT_RT_VERSION
  if (cuda_device_capability >= 90) {
    return DPCT_COMPAT_RT_VERSION >= 12000;
  } else if (cuda_device_capability >= 89) {
    return DPCT_COMPAT_RT_VERSION >= 12040;
  }
#endif
...
bool cutlass_scaled_mm_supports_block_fp8(int64_t cuda_device_capability) {
  ...
  if (cuda_device_capability >= 100) {
    return DPCT_COMPAT_RT_VERSION >= 12080;
...
bool cutlass_group_gemm_supported(int64_t cuda_device_capability) {
  ...
  if (cuda_device_capability >= 90) {
    return DPCT_COMPAT_RT_VERSION >= 12030;
  }
#endif
