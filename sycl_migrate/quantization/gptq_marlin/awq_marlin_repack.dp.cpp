...
void awq_marlin_repack_kernel(
  ...
  auto fetch_to_shared = [&](int pipe, int k_tile_id, int n_tile_id,
    ...
    sycl::int4* sh_ptr = sh + stage_size * pipe;
  ...
  /*
  DPCT1110:169: The total declared local variable size in device function
  ...
  */
  auto repack_tile = [&](int pipe, int k_tile_id, int n_tile_id,
    ...
    sycl::int4* sh_stage_ptr = sh + stage_size * pipe;
...
torch::Tensor awq_marlin_repack(torch::Tensor& b_q_weight, int64_t size_k,
  ...
  /*
  DPCT1019:351: local_mem_size in SYCL is not a complete equivalent of
