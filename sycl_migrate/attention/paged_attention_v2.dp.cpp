...
void paged_attention_v2_launcher(
  ...
  /*
  DPCT1083:241: The size of local memory in the migrated code may be different
  ...
  */
  ...
  /*
  DPCT1083:239: The size of local memory in the migrated code may be different
  from the original code. Check that the allocated memory size in the migrated
  code is correct.
  */
