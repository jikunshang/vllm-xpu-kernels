...
#pragma unroll
  for (int mask = WARP_SIZE / 2; mask >= 1; mask /= 2) {
    /*
    DPCT1096:414: The right-most dimension of the work-group used in the SYCL
...
#pragma unroll
  for (int mask = NUM_WARPS / 2; mask >= 1; mask /= 2) {
    /*
    DPCT1096:415: The right-most dimension of the work-group used in the SYCL
    kernel that calls this function may be less than "32". The function
    "dpct::permute_sub_group_by_xor" may return an unexpected result on the CPU
    device. Modify the size of the work-group to ensure that the value of the
    right-most dimension is a multiple of "32".
  ...
  /*
  DPCT1096:416: The right-most dimension of the work-group used in the SYCL
  kernel that calls this function may be less than "32". The function
...
/*
DPCT1110:233: The total declared local variable size in device function
...
void paged_attention_kernel(
    ...
    Q_vec q_vecs[THREAD_GROUP_SIZE][NUM_VECS_PER_THREAD], float* red_smem) {
...
#pragma unroll
  ...
  performance if there is no access to global memory.
  */
  item_ct1.barrier();  // TODO(naed90): possible speedup if this is replaced
...
#pragma unroll
  for (int mask = WARP_SIZE / 2; mask >= THREAD_GROUP_SIZE; mask /= 2) {
    /*
    DPCT1096:410: The right-most dimension of the work-group used in the SYCL
    kernel that calls this function may be less than "32". The function
    "dpct::permute_sub_group_by_xor" may return an unexpected result on the CPU
    device. Modify the size of the work-group to ensure that the value of the
    right-most dimension is a multiple of "32".
...
#pragma unroll
  for (int mask = NUM_WARPS / 2; mask >= 1; mask /= 2) {
    /*
    DPCT1096:411: The right-most dimension of the work-group used in the SYCL
    kernel that calls this function may be less than "32". The function
    "dpct::permute_sub_group_by_xor" may return an unexpected result on the CPU
    device. Modify the size of the work-group to ensure that the value of the
    right-most dimension is a multiple of "32".
  ...
  /*
  DPCT1096:412: The right-most dimension of the work-group used in the SYCL
  kernel that calls this function may be less than "32". The function
  "dpct::select_from_sub_group" may return an unexpected result on the CPU
  device. Modify the size of the work-group to ensure that the value of the
  right-most dimension is a multiple of "32".
...
#pragma unroll
    for (int mask = NUM_V_VECS_PER_ROW / 2; mask >= 1; mask /= 2) {
      /*
      DPCT1096:413: The right-most dimension of the work-group used in the SYCL
      kernel that calls this function may be less than "32". The function
...
#pragma unroll
    ...
    /*
    DPCT1118:234: SYCL group functions and algorithms must be encountered in
...
#pragma unroll
    ...
    /*
    DPCT1118:235: SYCL group functions and algorithms must be encountered in
    converged control flow. You may need to adjust the code.
    */
    /*
...
void paged_attention_v1_kernel(
  ...
  paged_attention_kernel<scalar_t, cache_t, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS,
      ...
      blocksparse_head_sliding_step, item_ct1, dpct_local, q_vecs, red_smem);
}
...
#pragma unroll
  for (int mask = WARP_SIZE / 2; mask >= 1; mask /= 2) {
    /*
    DPCT1096:419: The right-most dimension of the work-group used in the SYCL
    kernel that calls this function may be less than "32". The function
    "dpct::permute_sub_group_by_xor" may return an unexpected result on the CPU
    device. Modify the size of the work-group to ensure that the value of the
    right-most dimension is a multiple of "32".
...
#pragma unroll
  for (int mask = NUM_WARPS / 2; mask >= 1; mask /= 2) {
    /*
    DPCT1096:420: The right-most dimension of the work-group used in the SYCL
    kernel that calls this function may be less than "32". The function
    "dpct::permute_sub_group_by_xor" may return an unexpected result on the CPU
    device. Modify the size of the work-group to ensure that the value of the
    right-most dimension is a multiple of "32".
  ...
  /*
  DPCT1096:421: The right-most dimension of the work-group used in the SYCL
  kernel that calls this function may be less than "32". The function
  "dpct::select_from_sub_group" may return an unexpected result on the CPU
  device. Modify the size of the work-group to ensure that the value of the
  right-most dimension is a multiple of "32".
