    ...
    cgh.parallel_for(                                                          \
        ...
        [=](sycl::nd_item<3> item_ct1) [[sycl::reqd_sub_group_size(32)]] {     \
          vllm::paged_attention_v1_kernel<T, CACHE_T, HEAD_SIZE, BLOCK_SIZE,   \
              ...
              kv_block_stride_ct11, kv_head_stride_ct12, k_scale_ptr_ct13,     \
              v_scale_ptr_ct14, tp_rank_ct15, blocksparse_local_blocks_ct16,   \
              blocksparse_vert_stride_ct17, blocksparse_block_size_ct18,       \
...
void paged_attention_v1_launcher(
  ...
  /*
  DPCT1083:237: The size of local memory in the migrated code may be different
