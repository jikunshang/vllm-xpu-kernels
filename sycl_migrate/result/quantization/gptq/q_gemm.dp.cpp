...
void reconstruct_exllama_8bit_kernel_wrapper(
  ...
  queue.submit([&](sycl::handler& cgh) {
    /*
    DPCT1101:14: 'BLOCK_KN_SIZE' expression was replaced with a value.
...
void reconstruct_exllama_4bit_kernel_wrapper(
  ...
  queue.submit([&](sycl::handler& cgh) {
    /*
    DPCT1101:15: 'BLOCK_KN_SIZE' expression was replaced with a value.
    Modify the code to use the original expression, provided in comments,
    if it is correct.
    */
    sycl::local_accessor<int, 1> perm_acc_ct1(
...
void reconstruct_exllama_3bit_kernel_wrapper(
  ...
  queue.submit([&](sycl::handler& cgh) {
    /*
    DPCT1101:16: 'BLOCK_KN_SIZE' expression was replaced with a value.
    Modify the code to use the original expression, provided in comments,
    if it is correct.
    */
    sycl::local_accessor<int, 1> perm_acc_ct1(
...
void reconstruct_exllama_2bit_kernel_wrapper(
  ...
  queue.submit([&](sycl::handler& cgh) {
    /*
    DPCT1101:17: 'BLOCK_KN_SIZE' expression was replaced with a value.
    Modify the code to use the original expression, provided in comments,
    if it is correct.
    */
    sycl::local_accessor<int, 1> perm_acc_ct1(
...
void gemm_half_q_half_alt_4bit_kernel_wrapper(
  ...
  queue.submit([&](sycl::handler& cgh) {
    /*
    DPCT1101:18: 'BLOCK_M_SIZE_MAX' expression was replaced with a value.
    Modify the code to use the original expression, provided in comments,
    if it is correct.
    */
    /*
    DPCT1101:19: 'blockwidth2' expression was replaced with a value.
    Modify the code to use the original expression, provided in comments,
    if it is correct.
    */
    sycl::local_accessor<
...
void gemm_half_q_half_alt_8bit_kernel_wrapper(
  ...
  queue.submit([&](sycl::handler& cgh) {
    /*
    DPCT1101:20: 'BLOCK_M_SIZE_MAX' expression was replaced with a value.
    Modify the code to use the original expression, provided in comments,
    if it is correct.
    */
    /*
    DPCT1101:21: 'blockwidth2' expression was replaced with a value.
    Modify the code to use the original expression, provided in comments,
    if it is correct.
    */
    sycl::local_accessor<
...
void shuffle_exllama_weight(uint32_t* q_weight, int* q_perm, int height,
  ...
  if (q_perm) {
    ...
    // Replace qweights
    /*
    DPCT1124:13: cudaMemcpyAsync is migrated to asynchronous memcpy API. While
    ...
    */
    ...
    dpct::dpct_free(new_qweight, q_ct1);
  }
  dpct::dim3 blockDim, gridDim;
  blockDim.x = THREADS_X;
  blockDim.y = 1;
