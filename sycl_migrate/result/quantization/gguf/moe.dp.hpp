...
/*
DPCT1110:42: The total declared local variable size in device function moe_q
                ...
                cgh.parallel_for(
                    ...
                    [=](sycl::nd_item<3> item_ct1) {
                        moe_q4_0<scalar_t, need_check>(
                            ...
                            num_tokens_post_padded, exp_stride, ncols_x,
                            nrows_x, ncols_y, nrows_y, nrows_dst, top_k,
                            item_ct1,
                            tile_y_qs_acc_ct1
