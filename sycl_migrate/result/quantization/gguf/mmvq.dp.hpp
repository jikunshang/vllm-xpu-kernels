    ...
    stream->parallel_for(
        ...
        [=](sycl::nd_item<3> item_ct1) {
            mul_mat_vec_q<scalar_t, QK_K, QI2_K, block_q2_K, VDR_Q2_K_Q8_1_MMVQ,
                          vec_dot_q2_K_q8_1>(vx, vy, dst, ncols, nrows, nvecs,
                                             item_ct1);
        });
}
    ...
    stream->parallel_for(
        ...
        [=](sycl::nd_item<3> item_ct1) {
            mul_mat_vec_q<scalar_t, QK_K, QI3_K, block_q3_K, VDR_Q3_K_Q8_1_MMVQ,
                          vec_dot_q3_K_q8_1>(vx, vy, dst, ncols, nrows, nvecs,
                                             item_ct1);
        });
}
    ...
    stream->parallel_for(
        ...
        [=](sycl::nd_item<3> item_ct1) {
            mul_mat_vec_q<scalar_t, QK_K, QI4_K, block_q4_K, VDR_Q4_K_Q8_1_MMVQ,
                          vec_dot_q4_K_q8_1>(vx, vy, dst, ncols, nrows, nvecs,
                                             item_ct1);
        });
}
    ...
    stream->parallel_for(
        ...
        [=](sycl::nd_item<3> item_ct1) {
            mul_mat_vec_q<scalar_t, QK_K, QI5_K, block_q5_K, VDR_Q5_K_Q8_1_MMVQ,
                          vec_dot_q5_K_q8_1>(vx, vy, dst, ncols, nrows, nvecs,
                                             item_ct1);
        });
}
    ...
    stream->parallel_for(
        ...
        [=](sycl::nd_item<3> item_ct1) {
            mul_mat_vec_q<scalar_t, QK_K, QI6_K, block_q6_K, VDR_Q6_K_Q8_1_MMVQ,
                          vec_dot_q6_K_q8_1>(vx, vy, dst, ncols, nrows, nvecs,
                                             item_ct1);
        });
}
...
static void mul_mat_vec_iq2_xxs_q8_1_cuda(const void* vx, const void* vy,
    ...
    */
    stream->parallel_for(
        sycl::nd_range<3>(block_nums * block_dims, block_dims),
        [=](sycl::nd_item<3> item_ct1) {
            mul_mat_vec_q<scalar_t, QK_K, QI2_XXS, block_iq2_xxs, 1,
                          vec_dot_iq2_xxs_q8_1>(vx, vy, dst, ncols, nrows,
                                                nvecs, item_ct1);
        });
}
...
static void mul_mat_vec_iq2_xs_q8_1_cuda(const void* vx, const void* vy,
    ...
    */
    stream->parallel_for(sycl::nd_range<3>(block_nums * block_dims, block_dims),
                         [=](sycl::nd_item<3> item_ct1) {
                             mul_mat_vec_q<scalar_t, QK_K, QI2_XS, block_iq2_xs,
                                           1, vec_dot_iq2_xs_q8_1>(
                                 vx, vy, dst, ncols, nrows, nvecs, item_ct1);
                         });
}
...
static void mul_mat_vec_iq2_s_q8_1_cuda(const void* vx, const void* vy,
    ...
    */
    stream->parallel_for(sycl::nd_range<3>(block_nums * block_dims, block_dims),
                         [=](sycl::nd_item<3> item_ct1) {
                             mul_mat_vec_q<scalar_t, QK_K, QI2_S, block_iq2_s,
                                           1, vec_dot_iq2_s_q8_1>(
                                 vx, vy, dst, ncols, nrows, nvecs, item_ct1);
                         });
}
...
static void mul_mat_vec_iq3_xxs_q8_1_cuda(const void* vx, const void* vy,
    ...
    */
    stream->parallel_for(
        sycl::nd_range<3>(block_nums * block_dims, block_dims),
        [=](sycl::nd_item<3> item_ct1) {
            mul_mat_vec_q<scalar_t, QK_K, QI3_XXS, block_iq3_xxs, 1,
                          vec_dot_iq3_xxs_q8_1>(vx, vy, dst, ncols, nrows,
                                                nvecs, item_ct1);
        });
}
...
static void mul_mat_vec_iq1_s_q8_1_cuda(const void* vx, const void* vy,
    ...
    */
    stream->parallel_for(sycl::nd_range<3>(block_nums * block_dims, block_dims),
                         [=](sycl::nd_item<3> item_ct1) {
                             mul_mat_vec_q<scalar_t, QK_K, QI1_S, block_iq1_s,
                                           1, vec_dot_iq1_s_q8_1>(
                                 vx, vy, dst, ncols, nrows, nvecs, item_ct1);
                         });
}
...
static void mul_mat_vec_iq1_m_q8_1_cuda(const void* vx, const void* vy,
    ...
    */
    stream->parallel_for(sycl::nd_range<3>(block_nums * block_dims, block_dims),
                         [=](sycl::nd_item<3> item_ct1) {
                             mul_mat_vec_q<scalar_t, QK_K, QI1_M, block_iq1_m,
                                           1, vec_dot_iq1_m_q8_1>(
                                 vx, vy, dst, ncols, nrows, nvecs, item_ct1);
                         });
}
...
static void mul_mat_vec_iq4_xs_q8_1_cuda(const void* vx, const void* vy,
    ...
    */
    stream->parallel_for(sycl::nd_range<3>(block_nums * block_dims, block_dims),
                         [=](sycl::nd_item<3> item_ct1) {
                             mul_mat_vec_q<scalar_t, QK_K, QI4_XS, block_iq4_xs,
                                           1, vec_dot_iq4_xs_q8_1>(
                                 vx, vy, dst, ncols, nrows, nvecs, item_ct1);
                         });
}
...
static void mul_mat_vec_iq3_s_q8_1_cuda(const void* vx, const void* vy,
    ...
    */
    stream->parallel_for(sycl::nd_range<3>(block_nums * block_dims, block_dims),
                         [=](sycl::nd_item<3> item_ct1) {
                             mul_mat_vec_q<scalar_t, QK_K, QI3_XS, block_iq3_s,
                                           1, vec_dot_iq3_s_q8_1>(
                                 vx, vy, dst, ncols, nrows, nvecs, item_ct1);
                         });
}
