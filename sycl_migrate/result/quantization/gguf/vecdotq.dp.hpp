...
static __dpct_inline__ float vec_dot_q3_K_q8_1(
    ...
    const float d = sycl::vec<sycl::half, 1>(bq3_K->d)
                        .convert<float, sycl::rounding_mode::automatic>()[0];
...
static __dpct_inline__ void allocate_tiles_q3_K(
    int** x_ql, sycl::half2** x_dm, int** x_qh, int** x_sc, int* tile_x_ql,
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        x_ql[i * (2 * WARP_SIZE_GGUF + 1) + kq0] =
            dpct::vectorized_binary<sycl::char4>(ql0 | qh0, 0x20202020,
                                                 dpct::sub_sat());
        x_ql[i * (2 * WARP_SIZE_GGUF + 1) + kq1] =
...
static __dpct_inline__ float vec_dot_iq2_xxs_q8_1(
    const void* __restrict__ vbq, const block_q8_1* __restrict__ bq8_1,
    const int& iqs, const uint64_t* iq2xxs_grid, const uint8_t* ksigns_iq2xs,
    ...
    const float d = sycl::vec<sycl::half, 1>(bq2->d)
                        .convert<float, sycl::rounding_mode::automatic>()[0] *
                    (0.5f + aux32) *
                    sycl::vec<sycl::half, 1>(bq8_1[ib32].ds.x())
                        .convert<float, sycl::rounding_mode::automatic>()[0] *
                    0.25f;
    return d * sumi;
}
...
static __dpct_inline__ float vec_dot_iq2_xs_q8_1(
    const void* __restrict__ vbq, const block_q8_1* __restrict__ bq8_1,
    const int& iqs, const uint64_t* iq2xs_grid, const uint8_t* ksigns_iq2xs,
    const uint8_t* kmask_iq2xs) {
...
static __dpct_inline__ float vec_dot_iq2_s_q8_1(
    const void* __restrict__ vbq, const block_q8_1* __restrict__ bq8_1,
    const int& iqs, const uint64_t* iq2s_grid) {
#if defined DPCT_COMPATIBILITY_TEMP && DPCT_COMPATIBILITY_TEMP >= 610 || \
    defined USE_ROCM
...
static __dpct_inline__ float vec_dot_iq3_xxs_q8_1(
    const void* __restrict__ vbq, const block_q8_1* __restrict__ bq8_1,
    const int& iqs, const uint32_t* iq3xxs_grid, const uint64_t* ksigns64) {
#if defined DPCT_COMPATIBILITY_TEMP && DPCT_COMPATIBILITY_TEMP >= 610 || \
    defined USE_ROCM
    ...
    const float d = sycl::vec<sycl::half, 1>(bq2->d)
                        .convert<float, sycl::rounding_mode::automatic>()[0] *
                    (0.5f + aux32) * bq8_1[ib32].ds[0] * 0.5f;
    return d * sumi;
#endif
}
...
static __dpct_inline__ float vec_dot_iq3_s_q8_1(
    const void* __restrict__ vbq, const block_q8_1* __restrict__ bq8_1,
    const int& iqs, const uint32_t* iq3xs_grid) {
#if defined DPCT_COMPATIBILITY_TEMP && DPCT_COMPATIBILITY_TEMP >= 610 || \
    defined USE_ROCM
...
static __dpct_inline__ float vec_dot_iq1_s_q8_1(
    const void* __restrict__ vbq, const block_q8_1* __restrict__ bq8_1,
    const int& iqs, const uint64_t* iq1s_grid_gpu) {
#if defined DPCT_COMPATIBILITY_TEMP && DPCT_COMPATIBILITY_TEMP >= 610 || \
    defined USE_ROCM
...
#pragma unroll
    for (int l0 = 0; l0 < 8; l0 += 2) {
        ...
        sumi = dpct::dp4a(grid0, u0, sumi);
        sumi = dpct::dp4a(grid1, u1, sumi);
    }

    const float d1q = sycl::vec<sycl::half, 1>(bq1->d)
                          .convert<float, sycl::rounding_mode::automatic>()[0] *
                      (((qh >> 11) & 0x0E) + 1);
    const float  delta = -1.0f + IQ1S_DELTA - (qh & 0x8000) * (2.0f*IQ1S_DELTA/0x8000);
    const sycl::float2 ds =
        (bq8_1[iqs].ds).convert<float, sycl::rounding_mode::automatic>();
    return d1q * (ds.x() * sumi + ds.y() * delta);
#endif
}

static __dpct_inline__ float vec_dot_iq1_m_q8_1(
    const void* __restrict__ vbq, const block_q8_1* __restrict__ bq8_1,
    const int& iqs, const uint64_t* iq1s_grid_gpu) {
#if defined DPCT_COMPATIBILITY_TEMP && DPCT_COMPATIBILITY_TEMP >= 610 || \
    defined USE_ROCM
...
#pragma unroll
    for (int l0 = 0; l0 < 8; l0 += 2) {
        ...
        sumi[l0 / 4] = dpct::dp4a(grid0, u0, sumi[l0 / 4]);
        sumi[l0 / 4] = dpct::dp4a(grid1, u1, sumi[l0 / 4]);

        const float delta = -1.0f + IQ1M_DELTA - (qhl & 0x08) * (2.0f*IQ1M_DELTA/0x08);
        int sumy = 0;
        sumy = dpct::dp4a(u0, 0x01010101, sumy);
        sumy = dpct::dp4a(u1, 0x01010101, sumy);
...
static __dpct_inline__ float vec_dot_iq4_nl_q8_1(
    const void* __restrict__ vbq, const block_q8_1* __restrict__ bq8_1,
    const int& iqs, const int8_t* kvalues_iq4nl) {
#if defined DPCT_COMPATIBILITY_TEMP && DPCT_COMPATIBILITY_TEMP >= 610 || \
    defined USE_ROCM
    ...
    const float d = sycl::vec<sycl::half, 1>(bq->d)
                        .convert<float, sycl::rounding_mode::automatic>()[0] *
                    bq8_1->ds[0];
...
static __dpct_inline__ float vec_dot_iq4_xs_q8_1(
    const void* __restrict__ vbq, const block_q8_1* __restrict__ bq8_1,
    const int& iqs, const int8_t* kvalues_iq4nl) {
#if defined DPCT_COMPATIBILITY_TEMP && DPCT_COMPATIBILITY_TEMP >= 610 || \
    defined USE_ROCM
