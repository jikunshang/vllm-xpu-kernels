...
#pragma once
...
#ifndef USE_ROCM
  /*
  DPCT1098:309: The '*' expression is used instead of the __ldg call. These two
  ...
  */
  /*
  DPCT1064:310: Migrated __ldg call is used in a macro/template definition and
...
#ifndef USE_ROCM
  /*
  DPCT1121:232: Make sure that the "sum" which is used in the SYCL group
...
#ifndef USE_ROCM
  /*
  DPCT1027:396: The call to cudaFuncSetAttribute was replaced with 0 because
