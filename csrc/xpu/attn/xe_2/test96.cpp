...
template void policy_dispatch<chunk_policy_head96, chunk_prefill_args_t<true>>(
    sycl::queue&,
    c10::ScalarType,
    c10::ScalarType,
    const chunk_prefill_args_t<true>&);

template void policy_dispatch<chunk_policy_head96, chunk_prefill_args_t<false>>(
    sycl::queue&,
    c10::ScalarType,
    c10::ScalarType,
